...
// Popup box for GFF data
// This was old, and should be deleted soon
void displaygffMessageOld(String data) {
    int offset=0;
    stroke(#99CC00);
    strokeWeight(3);
    fill(255);
    rect(canvasWidth/2-100, canvasHeight/2-100, 200, 120, 10); 
    textAlign(LEFT);
    fill(#99CC00);
    textFont(helvetica18, 16);
    text("GFF Information:", canvasWidth/2 - 80, canvasHeight/2 - 80);
    fill(#333333);
    textFont(helvetica18, 14);
    text(data, canvasWidth/2 - 80, (canvasHeight/2)-60); 
    fill(255, 220);
    strokeWeight(2);
    stroke(220);
}
...
void displaygffMessage(String tipText_temp) {
    ...
    /// if there are more than 5 lines, e.g., when over a digit
    if (tooltip_textHeight > 120) {
        tooltip_mouseOffsetY = canvasHeight - mouseY-40;
        tooltip_mouseOffsetX = tooltip_mouseOffsetX + 15;
    }
